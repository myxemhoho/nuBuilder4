...
print 'Merge current data with new system tables<br>==================================================<br><br>';
...
function nuCopySystemFiles(){
    ...
    print '<br><br><span style="padding:10px;background-color:#d9e4fe">Copy SYSTEM FILES to TEMP FILES <br><br></span>';
...
function nuImportSystemFiles(){
    ...
    print '<br><br><span style="padding:10px;background-color:#d9e4fe">Import new SYSTEM FILES (nubuilder4.sql) <br><br></span>';
...
//    print "<br>Update TEMP FILE table structure's to SYSTEM FILES <br><br></span>";
    print '<br><br><span style="padding:10px;background-color:#d9e4fe">Update TEMP FILE table structure\'s to SYSTEM FILES <br><br></span>';
...
function nuAddNewSystemTables(){
    ...
    print '<br><br><span style="padding:10px;background-color:#d9e4fe">Copy SYSTEM FILES to TEMP FILES for any new tables added from the import. <br><br></span>';
...
function nuJustNuRecords(){
    ...
    print '<br><br><span style="padding:10px;background-color:#d9e4fe">Remove all ids not starting with nu from SYSTEM FILES <br><br></span>';
...
function nuRemoveNuRecords(){
    ...
    print '<br><br><span style="padding:10px;background-color:#d9e4fe">Remove all ids starting with nu from TEMP FILES <br><br></span>';
...
function nuAppendToSystemTables(){
    ...
    print '<br><br><span style="padding:10px;background-color:#d9e4fe">Insert TEMP FILES into SYSTEM FILES <br><br></span>';
